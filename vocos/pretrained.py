...
class MyVocos(nn.Module):
    ...
    @classmethod
    def from_hparams(cls, config_path: str) -> MyVocos:
        """
        Class method to create a new MyVocos model instance from hyperparameters stored in a yaml configuration file.
        """
    ...
    @classmethod
    def from_config(cls, config_path: str) -> MyVocos:
        """
        Class method to create a new MyVocos model instance from hyperparameters stored in a yaml configuration file.
        """
        with open(config_path, "r") as f:
    ...
    @classmethod
    def from_pretrained(cls, repo_id: str, revision: Optional[str] = None) -> MyVocos:
        """
        Class method to create a new MyVocos model instance from a pre-trained model stored in the Hugging Face model hub.
        """
